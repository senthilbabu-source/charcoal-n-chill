...
export function WhatsAppFloat() {
    return (
        <motion.a
            ...
            className="fixed bottom-6 right-6 z-[9999] flex items-center justify-center p-4 bg-[#25D366] text-white rounded-full shadow-[0_4px_14px_rgba(0,0,0,0.25)] hover:shadow-[0_6px_20px_rgba(37,211,102,0.4)] transition-shadow group"

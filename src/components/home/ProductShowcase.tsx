                    ...
                    <ScrollReveal animation="fade-right">
                        <div>
                            ...
                            <h2 className="text-4xl md:text-5xl font-black text-white">
                                Experience <span className="gradient-text">Perfection</span>
                            </h2>
                        </div>
                    </ScrollReveal>
                        ...
                        >
                            <Link href="/menu" className="block w-full h-full">
                                ...
                                <div className="absolute inset-0 w-full h-full overflow-hidden">
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-dark-primary via-dark-primary/20 to-transparent opacity-80 group-hover:opacity-60 transition-opacity duration-300" />
                                </div>
                                ...
                                <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-end">
                                    <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                                        <div className="flex justify-between items-end mb-2">
                                            <span className="text-gold-primary text-xs font-bold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity duration-300 -translate-y-2 group-hover:translate-y-0 delay-75">
                                                {item.category}
                                            </span>
                                            <span className="text-white font-bold bg-white/10 backdrop-blur-md px-3 py-1 rounded-full text-sm">
                                                {item.price}
                                            </span>
                                        </div>

                                        <h3 className="text-2xl font-bold text-white mb-2">{item.title}</h3>
                                        <p className="text-gray-300 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100 max-w-[80%]">
                                            {item.description}
                                        </p>
                                    </div>
